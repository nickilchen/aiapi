...
const translations = {
    'zh-CN': {
        // Header
        'header.title': 'AIAPI 管理控制台',
        'header.description': 'AIAPI 管理控制台 - 统一管理 AI 服务提供商',
        ...
        'dashboard.subtitle': '实时监控系统状态和服务信息',
        ...
        'nav.alerts': '告警通知',
        'alerts.title': '告警通知',
        'alerts.description': '配置和管理系统告警规则，接收实时通知',
        'alerts.testAlert': '测试告警',
        'alerts.clearHistory': '清除历史',
        'alerts.stats.total': '总告警数',
        'alerts.stats.unacknowledged': '未确认',
        'alerts.stats.acknowledged': '已确认',
        'alerts.stats.status': '实时状态',
        'alerts.stats.connecting': '连接中',
        'alerts.config.title': '告警规则配置',
        'alerts.config.enabled': '启用告警系统',
        'alerts.config.enabledHint': '关闭后将停止所有告警监控和通知',
        'alerts.config.rules': '告警规则',
        'alerts.config.notifications': '通知方式',
        'alerts.rules.providerHealth': '提供商健康状态',
        'alerts.rules.providerHealthDesc': '监控提供商账号的健康状态',
        'alerts.rules.errorRate': '错误率监控',
        'alerts.rules.errorRateDesc': '监控 API 请求的错误率',
        'alerts.rules.quotaUsage': '配额使用监控',
        'alerts.rules.quotaUsageDesc': '监控 API 配额使用情况',
        'alerts.rules.healthThreshold': '健康率阈值 (%)',
        'alerts.rules.healthThresholdHint': '当健康率低于此值时触发告警',
        'alerts.rules.errorThreshold': '错误率阈值 (%)',
        'alerts.rules.errorThresholdHint': '当错误率超过此值时触发告警',
        'alerts.rules.quotaThreshold': '配额阈值 (%)',
        'alerts.rules.quotaThresholdHint': '当配额使用超过此值时触发告警',
        'alerts.rules.cooldown': '冷却时间 (分钟)',
        'alerts.rules.cooldownHint': '同一告警的最小间隔时间',
        'alerts.rules.timeWindow': '时间窗口 (分钟)',
        'alerts.rules.timeWindowHint': '统计错误率的时间范围',
        'alerts.notifications.browser': '浏览器通知',
        'alerts.notifications.browserHint': '实时推送到浏览器',
        'alerts.notifications.requestPermission': '请求通知权限',
        'alerts.notifications.testNotification': '测试通知',
        'alerts.notifications.wecom': '企业微信通知',
        'alerts.notifications.wecomHint': '通过企业微信机器人推送',
        'alerts.notifications.wecomWebhookUrl': '企业微信 Webhook 地址',
        'alerts.notifications.wecomWebhookUrlHint': '企业微信群机器人的 Webhook 地址',
        'alerts.notifications.wecomWebhookUrlPlaceholder': '例如: https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...',
        'alerts.notifications.wecomMentionedList': '@成员列表 (可选)',
        'alerts.notifications.wecomMentionedListHint': '多个用户ID用逗号分隔，@all 表示提醒所有人',
        'alerts.notifications.wecomMentionedListPlaceholder': '例如: zhangsan,lisi 或 @all',
        'alerts.notifications.wecomMentionedMobileList': '@手机号列表 (可选)',
        'alerts.notifications.wecomMentionedMobileListHint': '多个手机号用逗号分隔',
        'alerts.notifications.wecomMentionedMobilePlaceholder': '例如: 13800138000,13900139000',
        'alerts.notifications.webhook': '自定义 Webhook',
        'alerts.notifications.webhookHint': '发送到自定义 HTTP 端点',
        ...
        'alerts.notifications.webhookMethod': '请求方法',
        ...
        'alerts.history.title': '告警历史',
        'alerts.history.allTypes': '所有类型',
        'alerts.history.allSeverities': '所有级别',
        'alerts.history.providerHealth': '提供商健康',
        'alerts.history.errorRate': '错误率',
        'alerts.history.quotaUsage': '配额使用',
        'alerts.history.info': '信息',
        'alerts.history.warning': '警告',
        'alerts.history.error': '错误',
        ...
        // Login
        'login.title': '登录 - AIAPI',
        'login.welcome': '欢迎回来',
        'login.heading': '请输入密码以继续访问',
        'login.password': '密码',
    ...
    'en-US': {
        // Header
        'header.title': 'AIAPI Management Console',
        'header.description': 'AIAPI Management Console - Unified management of AI service providers',
        ...
        'dashboard.subtitle': 'Real-time monitoring of system status and service information',
        ...
        // Alerts
        'nav.alerts': 'Alerts',
        'alerts.title': 'Alert Notifications',
        'alerts.description': 'Configure and manage system alert rules, receive real-time notifications',
        'alerts.testAlert': 'Test Alert',
        'alerts.clearHistory': 'Clear History',
        'alerts.stats.total': 'Total Alerts',
        'alerts.stats.unacknowledged': 'Unacknowledged',
        'alerts.stats.acknowledged': 'Acknowledged',
        'alerts.stats.status': 'Real-time Status',
        'alerts.stats.connecting': 'Connecting',
        'alerts.config.title': 'Alert Rule Configuration',
        'alerts.config.enabled': 'Enable Alert System',
        'alerts.config.enabledHint': 'Disabling will stop all alert monitoring and notifications',
        'alerts.config.rules': 'Alert Rules',
        'alerts.config.notifications': 'Notification Methods',
        'alerts.rules.providerHealth': 'Provider Health Status',
        'alerts.rules.errorRate': 'Error Rate Monitoring',
        'alerts.rules.quotaUsage': 'Quota Usage Monitoring',
        'alerts.rules.healthThreshold': 'Health Rate Threshold (%)',
        'alerts.rules.healthThresholdHint': 'Trigger alert when health rate falls below this value',
        'alerts.rules.errorThreshold': 'Error Rate Threshold (%)',
        'alerts.rules.errorThresholdHint': 'Trigger alert when error rate exceeds this value',
        'alerts.rules.quotaThreshold': 'Quota Threshold (%)',
        'alerts.rules.quotaThresholdHint': 'Trigger alert when quota usage exceeds this value',
        'alerts.rules.cooldown': 'Cooldown Period (minutes)',
        'alerts.rules.cooldownHint': 'Minimum interval between same alerts',
        'alerts.rules.timeWindow': 'Time Window (minutes)',
        'alerts.rules.timeWindowHint': 'Time range for error rate statistics',
        'alerts.notifications.browser': 'Browser Notifications',
        'alerts.notifications.browserHint': 'Display real-time alert notifications in browser',
        'alerts.notifications.requestPermission': 'Request Notification Permission',
        'alerts.notifications.email': 'Email Notifications',
        'alerts.notifications.smtpHost': 'SMTP Server',
        'alerts.notifications.smtpPort': 'Port',
        'alerts.notifications.smtpSecure': 'Use SSL/TLS',
        'alerts.notifications.smtpUser': 'Username',
        'alerts.notifications.smtpPass': 'Password',
        'alerts.notifications.emailFrom': 'From',
        'alerts.notifications.emailTo': 'To (comma separated)',
        'alerts.notifications.webhook': 'Webhook Notifications',
        'alerts.notifications.webhookUrl': 'Webhook URL',
        'alerts.notifications.webhookMethod': 'Request Method',
        'alerts.notifications.webhookHeaders': 'Custom Headers (JSON)',
        'alerts.history.title': 'Alert History',
        'alerts.history.allTypes': 'All Types',
        'alerts.history.allSeverities': 'All Severities',
        'alerts.history.providerHealth': 'Provider Health',
        'alerts.history.errorRate': 'Error Rate',
        'alerts.history.quotaUsage': 'Quota Usage',
        'alerts.history.info': 'Info',
        'alerts.history.warning': 'Warning',
        'alerts.history.error': 'Error',
        ...
        'common.welcome': 'Welcome to AIAPI Management Console!',
        ...
        // Login
        'login.title': 'Login - AIAPI',
        'login.welcome': 'Welcome Back',
        'login.heading': 'Please enter your password to continue',
