...
import { handleAlertApiRequests } from '../ui-modules/alert-api.js';
...
export async function handleUIApiRequests(method, pathParam, req, res, currentConfig, providerPoolManager) {
    ...
    // Handle alert API requests
    if (pathParam.startsWith('/api/alerts')) {
        return await handleAlertApiRequests(method, pathParam, req, res);
    }
